...
namespace MyTodoWebApi.Data.Helpers
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// </summary>
        public customerinfoContext DbContext { get; set; }
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<customerinfoContext, object> factory = null) where T : class
        {
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<customerinfoContext, object> factory, customerinfoContext dbContext)
        {
