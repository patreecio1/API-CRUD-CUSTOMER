...
using MyTodoWebApi.Data.Repository;
using MyTodoWebApi.Data.Contracts;

namespace MyTodoWebApi.Data.Helpers
{
    /// <summary>
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private IDictionary<Type, Func<customerinfoContext, object>> GetFactories()
        {
            return new Dictionary<Type, Func<customerinfoContext, object>>
            {
        ...
        /// </remarks>
        public RepositoryFactories(IDictionary<Type, Func<customerinfoContext, object>> factories)
        {
        ...
        /// </remarks>
        public Func<customerinfoContext, object> GetRepositoryFactory<T>()
        {

            Func<customerinfoContext, object> factory;
        ...
        /// </remarks>
        public Func<customerinfoContext, object> GetRepositoryFactoryForEntityType<T>() where T : class
        {
        ...
        protected virtual Func<customerinfoContext, object> DefaultEntityRepositoryFactory<T>() where T : class
        {
        ...
        /// </remarks>
        private readonly IDictionary<Type, Func<customerinfoContext, object>> _repositoryFactories;
